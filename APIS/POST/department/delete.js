...
router.post(ENDPOINTS.POST.DEPARTMENT.DELETE, security.verifyToken, security.verifyUser, security.verifyPrivilege(TABLES.COMPANY_DEPARTMENTS.TABLE, TABLES.LIST_PRIVILEGE.COLUMN.CAN_DELETE), async (req, res) => {
