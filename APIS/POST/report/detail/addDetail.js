...
router.post(ENDPOINTS.POST.REPORT.ADD_DETAIL, security.verifyToken, security.verifyUser, security.verifyPrivilege(TABLES.REPORT.TABLE, TABLES.LIST_PRIVILEGE.COLUMN.CAN_UPDATE), async (req, res) => {
