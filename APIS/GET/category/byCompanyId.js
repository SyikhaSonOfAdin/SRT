...
router.get(ENDPOINTS.GET.CATEGORY.BY_COMPANY_ID, security.verifyToken, security.verifyPrivilege(TABLES.LIST_CATEGORY.TABLE, TABLES.LIST_PRIVILEGE.COLUMN.CAN_READ), async (req, res) => {
