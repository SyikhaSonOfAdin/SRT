...
router.get(ENDPOINTS.GET.USER.BY_COMPANY_ID, security.verifyToken, security.verifyPrivilege(TABLES.USER.TABLE, TABLES.LIST_PRIVILEGE.COLUMN.CAN_READ), async (req, res) => {
